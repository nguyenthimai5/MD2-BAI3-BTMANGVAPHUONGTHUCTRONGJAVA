...
public class BT6_Tinhtongmotsoowcotchidinh {
    public static void main(String[] args) {
        System.out.println("Tìm tổng một số cột được chỉ định");
        ...
        System.out.println("Nhập số cột bạn muốn tính:");
       int nhapSoCotMuonTinh=scanner.nextInt();
        int tong=0;
        for (int i = 0; i < soDong; i++) {
            for (int j = 0; j < soCot; j++) {
                if (nhapSoCotMuonTinh==j){
                    tong +=mang2Chieu[i][j];
                }
            }
